...
A cloud automation project focused on provisioning an AWS EC2 server and configuring Nginx using Terraform and Ansible.

This project demonstrates my understanding of infrastructure automation, server configuration, and repeatable deployment practices.

Key work completed:

- Provisioned AWS EC2 infrastructure using Terraform
- Configured an Ubuntu server environment
- Used Ansible to automate Nginx installation and setup
- Applied basic cloud server configuration practices
- Organized the project for repeatable deployment
- Documented the process so another person can understand and reproduce it

Repo link: https://github.com/ucfavour23/ec2-nginx-terraform-ansible
...
- Project links
- Skills summary
- Career direction toward junior cloud, cloud support, DevOps intern, and remote technical support roles
...
- AWS support and monitoring
- Linux server administration
- Cloud documentation and runbooks
...
I believe good cloud work is not only about creating resources. It is also about making systems understandable, supportable, secure, and reliable.
